...
class Janitor:
    """
    Security Class for handling file operations.
    Ensures no file is deleted without cryptographic verification.
    """
    ...
    def secure_move(source_path: str, destination_folder: str) -> bool:
        ...
        if not os.path.exists(destination_folder):
            try:
                ...
                print(f"[JANITOR] Error creating directory: {e}")
                return False
        ...
        try:
            ...
            # 2. Verify
            source_hash = Janitor.calculate_md5(source_path)
            dest_hash = Janitor.calculate_md5(dest_path)
